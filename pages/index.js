          ...
          <div className={styles.glass}>
            <div className={styles.header} style={{ justifyContent: matchRespo ? 'space-between' : '' }}>
              <div className={styles.brand}>
                ...
                <Image id="logo" src="/Bridgeon.svg" width={matchRespo ? 70 : 150} height={50} alt="logo" />
              </div>
            ...
            <div className={styles.body} align="center" >
              <Grid justify="center">
                <Grid.Col span={!matchRespo ? 6 : 12} justify="center" align="center">
                  <div className={styles.training} onClick={() => window.open("https://forms.gle/yEoFuXRr2Kwg7esi9", "blank")} style={{ boxShadow: matchRespo ? "-5px 8px 20px 0px #0606064a" : "" }}>
                    <div className={styles.holder} style={{ width: !matchRespo ? "" : "100%", height: !matchRespo ? "100%" : "", }}>
                      ...
                      {!matchRespo ? <div className={styles.scroller}>
                        <p style={{ fontSize: matchRespo ? '15px' : "20px" }}>
                ...
                <Grid.Col span={!matchRespo ? 6 : 12} justify="center" align="center">
                  <div className={styles.service} style={{ boxShadow: matchRespo ? "-5px 8px 20px 0px #0606064a" : "" }}>
                    <div className={styles.holder} style={{ width: !matchRespo ? "" : "100%", height: !matchRespo ? "100%" : "" }}>
                      <h2 style={{ fontSize: matchRespo ? '15px' : "x-large" }}>
